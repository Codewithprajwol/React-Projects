   ...
   const [selectedImage,setSelectedImage]=useState(null)
    ...
    return (
     ...
     <div className={style['img-container']}>
        <h3 className={style['img-text']}>Select your images</h3>
        <div className={style['img-inner-container']}>  
            {images.map((image)=>(
                <div onClick={selectImage} className={style['single-img-container']}>
        ...
        <div className={style['show-image']}>
            {
                selectedImage && (<div className={style['show-image-container']}>
